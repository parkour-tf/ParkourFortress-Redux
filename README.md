...
* Linux (x86) - Tested on Ubuntu, Gentoo, and Oracle Linux/RHEL.
* Linux (x86-64) - Tested on Oracle Linux/RHEL.

Windows is not officially supported, but there's no reason it wouldn't work if you added the gamedata yourself.

## Requirements

* Metamod:Source 2.0.0
* SourceMod 1.13.0
...
Serafeline (Jon S.), oWave (Tobias K.)
